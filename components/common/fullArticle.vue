<template>
    <div class="relative min-h-[100vh] lg:h-screen next-module pc-screen-dom" :class="fullArticleClass">
        <div class="cont-wrap will-change" v-if="fullArticleClass?.includes('enlarge')">
            ...
            <div class='absolute top-0 left-0 flex flex-col justify-between items-center w-full h-full min-h-svh text-white' :class="['pt-[3rem] lg:pt-[2rem] pb-[2.09rem] lg:pb-[1.16rem]',props.content.titleContentClass]">
