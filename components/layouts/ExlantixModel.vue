<template>
  <div :class="['model-nav-wrapper', props.isActive ? 'active' : '']">
    ...
    <div class="model-nav-right">
      ...
      >
        <BaseImg class="nav-img img-bg" :src="item.bgSrc" />
        <div class="nav-text">
          <div
            :class="[
              'nav-text-switch',
          ...
          <template v-if="item.isSwitchActive === 1">
            ...
            <div class="nav-text-right">
              <div class="nav-text-inner" v-for="i in item.quota" :key="i.name">
                ...
                <span class="text-inner-bottom" v-html="i.name" style="white-space: pre;"></span>
              </div>
            </div>
          </template>
          <template v-else>
...
const modelList = [
  {
    ...
    withSwitch: true,
    switchLeftText: "BEV",
    switchRightText: "REEV",
    icon: "common/flash.svg",
    carSrc: "common/h-car-on-es.png",
    signSrc: "common/h-car-on-t-es.png",
    bgSrc: "common/nav02.png",
    title: "CONTROL YOUR FURIOUS JOURNEY",
    quota: [
      {
        isNum: true,
        numArr: [3, ".", 7],
        unit: "s",
        name: "0-100 Kph<br>Acceleration Time",
      },
      {
        isNum: true,
        numArr: [3, 5, 3],
      ...
      },
      {
        ...
        numArr: [3, 3, ".", 1],
        unit: "m",
        name: "Minimum<br>Braking Distance",
      },
    ],
    child: {
      title: "CONTROL YOUR FURIOUS JOURNEY",
  ...
  },
  {
    ...
    switchRightText: "REEV",
    icon: "common/flash.svg",
    carSrc: "common/h-car-on-et_2024.png",
    signSrc: "common/h-car-on-t-et.png",
    bgSrc: "common/nav01.png",
    title: "REDEFINE ENGINE EMBRACE VOYAGE",
    quota: [
      {
        isNum: true,
        numArr: [1, 9, ".", 8],
      ...
      },
      {
        ...
        numArr: [1, 0],
        unit: "min",
        name: "800 V fast charging<br>SOC 20-80%",
      },
    ],
    child: {
      title: "CONTROL YOUR FURIOUS JOURNEY",
...
const navList = ref(modelList.map((v) => {
