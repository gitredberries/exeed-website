...
const techList = [
  {
    id: 1,
    src: "common/top_10_powertrain.png",
    desc: "2024 China Top 10 Powertrain",
  },
  {
    id: 2,
    src: "common/Capsule_class_cage_body_technology.png",
    desc: "Safety Always as the Top Priority",
  },
  {
    id: 3,
    src: "common/AWD.png",
    desc: "AWD with Ease as a Global Leader",
  },
];

const navList = reactive(techList.map(v => {
  let arr = navData[2]?.children || [];
