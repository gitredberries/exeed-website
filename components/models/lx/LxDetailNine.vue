...
const swipList = reactive([
  {
    src: "models/lx/27.jpg",
    mSrc: "models/h5/01mob.jpg",
    paginationSrc: "models/lx/17.png",
    name: "Vanilla blue",
    isActive: true,
  },
  {
    src: "models/lx/23.jpg",
    mSrc: "models/h5/02mob.jpg",
    paginationSrc: "models/lx/18.png",
    name: "Aviation silver",
    isActive: false,
  },
  {
    src: "models/lx/24.jpg",
    mSrc: "models/h5/03mob.jpg",
    paginationSrc: "models/lx/19.png",
    name: "New khaki white",
    isActive: false,
  },
  {
    src: "models/lx/25.jpg",
    mSrc: "models/h5/04mob.jpg",
    paginationSrc: "models/lx/20.png",
    name: "Blood red",
    isActive: false,
  },
  {
    src: "models/lx/26.jpg",
    mSrc: "models/h5/05mob.jpg",
    paginationSrc: "models/lx/21.png",
    name: "Havana gray",
    isActive: false,
  },
]);
