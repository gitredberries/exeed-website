...
<template>
  ...
  <div class="detail" ref="targetRef">
    ...
    <BaseImg class="img_01" src="models/rx/1.png" alt="" />
    <BaseImg class="img_02" src="models/h5/33.png" alt="" />
    <div class="detail_content">
      <div class="detail_title">
        <div class="title_01">EXPLORE YOUR MODERN SELF</div>
        <div class="title_02">THE NEW LX</div>
      </div>
    </div>
...
watch(isVisible, (newVal) => {
  const selectors = [".img_01", ".title_01", ".title_02", ".title_Jump"];
