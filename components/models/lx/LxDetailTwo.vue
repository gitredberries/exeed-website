  ...
  <div class="detail" ref="targetRef" :class="{ active: isVisible }">
    ...
    <div class="title_content">
      <div class="item" :class="{ animate: isVisible }">
        ...
        <div class="item_tent">
          <div class="item_content">
            <BaseImg src="models/lx/05.jpg" alt="" />
      ...
      <div class="item" :class="{ animate: isVisible }">
        ...
        <div class="item_tent">
          <div class="item_content btn">
            <BaseImg src="models/lx/06.jpg" alt="" />
            <div class="digit">
              <CountTo value="6" />
            </div>
          </div>
      ...
      <div class="item" :class="{ animate: isVisible }">
        ...
        <div class="item_tent">
          <div class="item_content">
            <baseImg src="models/lx/07.jpg" alt="" />
        ...
        <div class="item_tent">
          <div class="item_content">
            <div class="digit btn_01">
              <CountTo value="1" />. <CountTo value="6" />TGDI+
              <CountTo value="7" />D<br />CT
            </div>
            <div class="digit btn_02">
              <CountTo value="1" />. <CountTo value="6" />TGDI+
              <CountTo value="7" />DCT
            </div>
          </div>
