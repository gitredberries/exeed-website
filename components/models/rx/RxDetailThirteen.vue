...
const swipList = reactive([
  {
    src: "models/rx/72.jpg",
    mSrc: "models/rx/79.jpg",
    paginationSrc: "models/rx/65.png",
    name: "Carbon Crystal Black",
    isActive: true,
  },
  {
    src: "models/rx/73.jpg",
    mSrc: "models/rx/80.jpg",
    paginationSrc: "models/rx/66.png",
    name: "Khaki White",
    isActive: false,
  },
  {
    src: "models/rx/74.jpg",
    mSrc: "models/rx/81.jpg",
    paginationSrc: "models/rx/67.png",
    name: "Tech Gray",
    isActive: false,
  },
  {
    src: "models/rx/75.jpg",
    mSrc: "models/rx/82.jpg",
    paginationSrc: "models/rx/68.png",
    name: "Venetian Blue",
    isActive: false,
  },
  {
    src: "models/rx/76.jpg",
    mSrc: "models/rx/83.jpg",
    paginationSrc: "models/rx/69.png",
    name: "Green Plum",
    isActive: false,
  },
  {
    src: "models/rx/77.jpg",
    mSrc: "models/rx/84.jpg",
    paginationSrc: "models/rx/70.png",
    name: "Matte Gray",
    isActive: false,
  },
  {
    src: "models/rx/78.jpg",
    mSrc: "models/rx/85.jpg",
    paginationSrc: "models/rx/71.png",
    name: "Black & White",
    isActive: false,
  },
]);
