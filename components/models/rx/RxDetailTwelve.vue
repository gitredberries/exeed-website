...
const contentData = ref([
  {
    title: "85% Steel Structure Body",
    description:
      "Cage-type energy absorption capsule body, with 85% high-strength steel energy absorption body",
    image: "models/rx/63.jpg",
  },
  {
    title: "8 Airbags all-round Guarantee Your Safety",
    description:
      "Comprehensively and meticulously protect the safety of travel personnel, whether it is the front passenger seat, or the back seat space, there are airbags to protect your life safety throughout the whole process",
    image: "models/rx/64.jpg",
  },
]);
