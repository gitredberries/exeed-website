...
const contentData = ref([
  {
    ...
    description: "The high-strength steel cage body design ensures that the vehicle remains structurally intact in the event of a collision, providing reliable protection for the driver and passengers. The B-pillar tensile strength is as high as 1,500 MPa, and the body is capable of withstanding 10 tonnes of overhead load, significantly improving the vehicle's anti-impact performance.",
    image: "models/txl/52.jpg",
  },
  {
    title: "6 Airbags For Driver Safety",
    description: "Including the main/passenger airbags, front seat side airbags, as well as front and rear side air curtains, giving the driver and passenger all-round and no-dead-angle protection.",
      image: "models/txl/53.jpg",
  },
  {
    title: "C-NCAP Five-star Safety Certification",
    description: "C-NCAP 5-star safety certification",
    image: "models/txl/54.jpg",
  },
]);
