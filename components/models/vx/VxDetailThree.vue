<template>
  ...
  <div class="detail" ref="targetRef">
    ...
    />
    <BaseImg class="img_02" src="models/h5/02.jpg" alt="" />
    <!-- 动态生成热点按钮 -->
    <div
...
const hotspotData = [
  {
    ...
    description:
      "Equipped with a 1360 x 870 mm panoramic sliding sunroof, you'll experience an exciting sense of freedom and enjoy a pleasant light-filled interior. The oversized sliding sunroof also adds a special charm, enhancing its luxurious appearance.",
    image: "models/vx/65.jpg",
  },
  {
    title: "The Leonids front grille",
    description:
    ...
    image: "models/vx/66.jpg",
  },
  {
    title: "Fully LED head optics",
    description:
      "Fully LED head optics of the VX is supplemented by options of illumination of turns and dynamic turn indexes. The daytime running lamps located lower are also made with the LED technology.",
    image: "models/vx/67.jpg",
  },
  {
    title: "Wheel styling upgrading",
    description:
      "The design of 20-inch two-colored alloy wheels is developed specially for the VX model and completed by Continental tyres.",
    image: "models/vx/68.jpg",
  },
];
...
const banner2Content = ref({
  ...
  type: "video",
  videoUrl: "index/video/vx_detail3.mp4",
});
...
.zoomed {
  transform: scale(1.5) translate(-4.2rem, 1rem);
  transition: transform 0.5s ease;
}
.zoomed_02 {
  transform: scale(1.4) translate(-4.2rem, 1rem);
  transition: transform 0.5s ease;
}
.zoomed_03 {
  transform: scale(1.5) translate(-4.7rem, 1rem);
  transition: transform 0.5s ease;
}
.zoomed_04 {
  transform: scale(1.6) translate(-5.1rem, -0.5rem);
  transition: transform 0.5s ease;
}
.full-screen {
