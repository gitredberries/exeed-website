...
const contentData = ref([
  {
    title: "High-performance Integrated Cage Body",
    description:
      "It boasts a high-performance integrated cage body. As the proportion of high-strength steel in the body is as high as 85%, and the usage rate of double-sided galvanized steel plate is as high as 54%, the tensile strength of the B-pillar is 1500MPa.",
    image: "models/vx/45.jpg",
  },
  {
    title: "10 Airbags For Boss Safety",
    description:
      "It is equipped with 10 airbags (an ultra long curtain of 2602mm). On the basis of the airbags of ordinary vehicle models, it not only has an ultra long curtain of 2602mm, knee airbag for the driver seat, and the center airbag for front seats, but also an additional side airbag for the middle row of seats, achieving the peer-leading 10-airbag configuration, comprehensively safeguarding driving and riding safety for boss!",
    image: "models/vx/46.jpg",
  },
  {
    title: "C-NCAP Five-star Safety Certification",
    description: "C-NCAP 5-star safety certification",
    image: "models/vx/47.jpg",
  },
])
