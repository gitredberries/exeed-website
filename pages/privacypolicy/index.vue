<template>
  <div class="text_box">
    <div class="t_title">PRIVACY STATEMENT OF EXEED WEBSITE</div>
    <div class="t_t1">
      <div>Version update date:May 6, 2025</div>
      <div>Version effective date:May 13, 2025</div>
    </div>
    <div class="t_t2">
      <div>
        The entity responsible for the processing of personal data referred to below is Anhui EXEED Automobile Co.,Ltd (hereinafter referred to as “EXEED”, “we” or “us”), a private company with limited liability established under the local and international laws and regulations, having its statutory seat in No. 236, Yinhu North Rd, Free Trade Pilot Zone, Wuhu Area ,Anhui , China. To ensure compliance with local and international data protection legislation, EXEED is the data controller of this personal data.
      </div>
      <div>
      ...
      <div class="mr_01">This Privacy Statement does not apply to:</div>
      <div class="pinch_in_1">
      ...
      <div class="pinch_in_1">· Your use of mobile apps provided by EXEED;</div>
      <div class="pinch_in_1">
      ...
      <div class="pinch_in_1">2. What third-party services do we use?</div>
      <div class="pinch_in_1">3. With whom will we share this data?</div>
      <div class="pinch_in_1">
      ...
      <div class="pinch_in_1">6. How long do we retain your data?</div>
      <div class="pinch_in_1">7. How do we protect your data?</div>
      <div class="pinch_in_1">8. Privacy of Children</div>
      <div class="pinch_in_1">9. How can you contact us and make a request？</div>
      <div class="pinch_in_1">
    ...
    <div class="t_t2">To ensure information security, and to understand and improve our products and services.</div>

    <div class="t_tab1">
      <div class="t_tab1_title">
        <div>Data Processing Purpose</div>
        <div>Type of Personal Data</div>
        <div>Legal Basis for Processing</div>
      </div>
      <div class="t_tab1_t1">
        <div>
    ...
    <div class="t_t3">2. What third-party services do we use?</div>

    <div class="t_t2">
      <div>
        On our websites, we incorporate social plugins from popular social networks like Instagram and Facebook. Here’s how they work:
      </div>
      <div class="mt_1">
      ...
      <div class="mt_1">
        ...
        <NuxtLink to="/cookiesPolicy">Cookies Notice</NuxtLink>.
      </div>
      <br />
      <div>
    ...
    <div class="t_t3">3. With whom will we share this data?</div>

    <div class="t_t4">3.1 Affiliates and subsidiaries</div>
    ...
    <div class="t_tab1">
      <div class="t_tab1_title">
        <div>Categories of providers</div>
        <div class="w_2">Reason for Sharing</div>
      </div>
      <div class="t_tab1_t1">
        <div>IT-providers and their sub-processors</div>
        <div class="w_2">
    ...
    <div class="t_t4">3.3 Law enforcement and government authorities</div>
    ...
    <div class="t_t3">4. How do we transfer your data outside your region?</div>

    <div class="t_t2">
      EXEED is a global company, and we operate internationally. By making a purchase or otherwise submitting your personal data to us, your information may be transferred to EXEED in the countries other than your place of residence or in which the information was originally collected. For example, where we have facilities or in which we engage service providers. EXEED complies with laws on the transfer of personal data between countries to help ensure your data is protected as described in this Statement, wherever it may be.
    </div>

    <div class="t_t2">
      We may rely on various legal grounds to collect, use, and otherwise process your information, including: your consent; that the information is necessary for the performance of a contract with you; to comply with a legal obligation; to protect your, or someone else vital interests; or for a legitimate interest that is balanced against your rights and interests. These legitimate interests may include EXEED interest in improving its products and services, enhancing safety and security, protecting EXEED or its business partners against wrongful conduct, and responding to customer inquiries and claims. Where applicable, we will inform you whether and why we need certain information from you, for example, whether we need the information to fulfill a legal or contractual requirement and what the consequences are of not providing the information.
    </div>

    <div class="t_t2">
      If you are located in the European Economic Area (EEA), the United Kingdom (UK), or Switzerland, we ensure that the transfer of your personal data is carried out in accordance with applicable privacy laws and, in particular, that appropriate contractual, technical, and organizational measures are in place. EXEED's international transfer of personal data collected in the EEA, the UK, and Switzerland is governed by Standard Contractual Clauses. The controller of personal data relating to individuals located in the EEA, UK, or Switzerland, is O&J Automotive Netherlands B.V.
    </div>
    ...
    <div class="t_t4">5.1 Right to withdraw consent</div>
    ...
    <div class="t_t4">5.2 Right to access your personal data</div>
    ...
    <div class="t_t4">5.3 Right to rectification</div>
    ...
    <div class="t_t4">5.4 Right to restriction</div>
    ...
    <div class="t_t2">
      ...
      <div>
        <span class="s_t1">·</span>You contest the accuracy of your personal data, for the period we need to verify the accuracy;
      </div>
      <div>
        <span class="s_t1">·</span>The processing is unlawful and you request the restriction of processing rather than erasure of your personal data;
      </div>
      <div>
        <span class="s_t1">·</span>We no longer need your personal data for the processing purpose, but you require them for the establishment, exercise, or defense of legal claims; or
      </div>
      <div>
        <span class="s_t1">·</span>You object to the processing while we verify whether our legitimate grounds override yours.
      </div>
    </div>

    <div class="t_t4">5.5 Right to portability</div>
    ...
    <div class="t_t4">5.6 Right to erasure</div>
    ...
    <div class="t_t2">
      ...
      <div>
        <span class="s_t1">·</span>Compliance with a legal obligation requiring processing by laws to which we are subject;
      </div>
      <div>
        <span class="s_t1">·</span>Archiving purposes in the public interest, scientific or historical research purposes, or statistical purposes; or
      </div>
      <div>
        <span class="s_t1">·</span>The establishment, exercise, or defense of legal claims.
      </div>
    </div>

    <div class="t_t4">5.7 Right to object</div>
    ...
    <div class="t_t4">5.8 Right to be informed</div>
    ...
    <div class="t_t4">5.9 Right to lodge a complaint</div>
    ...
    <div class="t_t3">6. How long do we retain your data?</div>
    ...
    <div class="t_t3">7. How do we protect your data?</div>
    ...
    <div class="t_t3">8. Privacy of children</div>

    <div class="t_t2">
      We do not knowingly collect or use any personal data from children (as defined by applicable law) without prior, verifiable consent which is given or authorized by the holder of parental responsibility over the child. We do not knowingly allow children to order our vehicles, communicate with us, or use any of our online services.
    </div>
    ...
    <div class="t_t3">9. How can you contact us and make a request?</div>
    ...
    <div class="t_t2">
      ...
      <div>E-mail Address: <a>privacy@mychery.com</a></div>
      <div>
    ...
    <div class="t_t3">10. How will we update this Privacy Statement?</div>
